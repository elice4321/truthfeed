...
export const strings = {
  ...
  hi: {
    appName: 'TruthFeed',
    tagline: 'शेयर करने से पहले जाँचें',
    checkBtn: 'WhatsApp फॉरवर्ड जाँचें',
    todayChecks: 'आज जाँचे गए फॉरवर्ड',
    misinformation: 'पकड़ी गई अफवाहें',
    verifiedNews: 'आज की सत्यापित खबरें',
    checkPlaceholder: 'WhatsApp मैसेज यहाँ पेस्ट करें...',
